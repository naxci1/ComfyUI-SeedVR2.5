...
"""
    ...
    perf_group.add_argument("--attention_mode", type=str, default="sdpa",
                        choices=["sdpa", "flash_attn_2", "flash_attn_3", "sageattn_1", "sageattn_2", "sageattn_3", "sparge_sage2"],
                        help="Attention backend: 'sdpa' (default), 'flash_attn_2', 'flash_attn_3', 'sageattn_1' (Turing/RTX 20xx), 'sageattn_2', 'sageattn_3' (Blackwell GPUs), or 'sparge_sage2' (block-sparse, Blackwell optimized)")
