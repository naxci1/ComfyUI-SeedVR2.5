...
"""
    ...
    perf_group.add_argument("--attention_mode", type=str, default="auto",
                        choices=["auto", "sdpa", "flash_attn_2", "flash_attn_3", "sageattn_2", "sageattn_3"],
                        help="Attention backend: 'auto' (default, selects best for your GPU), 'sdpa', 'flash_attn_2', 'flash_attn_3', 'sageattn_2', or 'sageattn_3' (Blackwell GPUs)")
